...
*/
	...
	for (int m = 0;m<no_of_equations;m++)
	{
		...
		{
			if(m==n){
				cout<<"\x1B[33m"<<setfill(' ')<<setw(10)<<coefficient_matrix[m][n];
			}
			else
			{
				cout<<"\x1B[39m"<<setfill(' ')<<setw(10)<<coefficient_matrix[m][n];
			}			
		}
		cout<<endl;
	}		
	...
	{
		cout<<"\x1B[39m"<<solution[zz]<<" ";
	}*/

	cout<<"\x1B[39m"<<endl<<endl;
